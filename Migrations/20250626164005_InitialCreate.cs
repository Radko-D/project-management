    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "#FF0000", new DateTime(2025, 6, 26, 16, 40, 5, 423, DateTimeKind.Utc).AddTicks(4587), "Bug" },
                    { 2, "#00FF00", new DateTime(2025, 6, 26, 16, 40, 5, 423, DateTimeKind.Utc).AddTicks(4672), "Feature" },
                    { 3, "#0000FF", new DateTime(2025, 6, 26, 16, 40, 5, 423, DateTimeKind.Utc).AddTicks(4672), "Enhancement" },
                    { 4, "#FFA500", new DateTime(2025, 6, 26, 16, 40, 5, 423, DateTimeKind.Utc).AddTicks(4673), "Documentation" },
                    { 5, "#800080", new DateTime(2025, 6, 26, 16, 40, 5, 423, DateTimeKind.Utc).AddTicks(4674), "Testing" }
                });
